...
CREATE TABLE IF NOT EXISTS `ereciclar`.`location` (
  ...
  `type` ENUM('COLLECTOR_MAN', 'COLLECTOR_COMPANY', 'DISCARD_POINT', 'DONATION', "USER_DONATION") NOT NULL,
...
START TRANSACTION;
USE `ereciclar`;
INSERT INTO `ereciclar`.`location` (`location_id`, `zipcode`, `street`, `number`, `state`, `city`, `country`, `additional`, `latitude`, `longitude`, `type`, `create_at`, `update_at`) VALUES (1, '05773020', 'Rua Bernardo Correia Leitão', '941', 'São Paulo', 'SP', 'Brasil', 'Casa', NULL, NULL, 'COLLECTOR_MAN', DEFAULT, NULL);
